<template>
  ...
  <div
    class="modal fade"
    id="kt_modal_editindikator"
    ref="newModalEditIndikator"
    tabindex="-1"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h3>Edit Indikator Kinerja Direktur</h3>
        ...
        <div class="modal-body">
          ...
          <!--end::Notice-->
          <el-form
            id="kt_modal_editindikator_form"
          ...
          >
            ...
            <div class="d-flex flex-column mb-5 fv-row">
              ...
              <el-form-item prop="targetKinerja">
                <el-input
                  v-model="targetData.targetKinerja"
            ...
            <div class="float-end">
              <button
                type="reset"
                id="kt_modal_editindikator_cancel"
...
export default defineComponent({
  ...
  setup() {
    ...
    const newModalEditIndikator = ref<null | HTMLElement>(null);
        ...
        if (valid) {
          ...
          setTimeout(() => {
            ...
            Swal.fire({
              ...
              hideModal(newModalEditIndikator.value);
            });
          }, 2000);
        } else {
          Swal.fire({
