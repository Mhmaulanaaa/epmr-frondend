<template>
  ...
  <div
    class="modal fade"
    id="kt_modal_editsasaran"
    ref="newModalEditSasaran"
    tabindex="-1"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
        ...
        <div class="modal-body">
          ...
          >
            ...
            <div class="d-flex flex-column mb-5 fv-row">
              <!--begin::Label-->
              <label class="d-flex align-items-center fs-6 fw-semobold mb-2">
                <span class="required">Sasaran Direktur</span>
              </label>
              <!--end::Label-->
            ...
            <div class="float-end">
              <button
                type="reset"
                id="kt_modal_editsasaran_cancel"
...
export default defineComponent({
  ...
  setup() {
    ...
    const newModalEditSasaran = ref<null | HTMLElement>(null);
        ...
        if (valid) {
          ...
          setTimeout(() => {
            ...
            Swal.fire({
              ...
              hideModal(newModalEditSasaran.value);
            });
          }, 2000);
        } else {
          Swal.fire({
