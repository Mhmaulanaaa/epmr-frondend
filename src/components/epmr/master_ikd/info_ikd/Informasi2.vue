              ...
              <tbody>
                <tr class="fs-7" v-for="(title, i) in tableHead" :key="i">
                  ...
                  <td class="text-center">
                    <KTModalComp modal-id="kt_modal_editindikator">
                    </KTModalComp>
                  </td>
                </tr>
              </tbody>
...
import KTEditIndikator from "@/components/epmr/master_ikd/modal_edit/edit_ikd/EditIndikator.vue";
import KTModalComp from "@/components/epmr/master_ikd/modal_edit/edit_ikd/modal_comp/ModalCompIndikator.vue";
