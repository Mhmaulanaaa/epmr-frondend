            ...
            >
              <thead>
                ...
                >
                  ...
                  <th class="text-center">Indikator Kinerja Direktur</th>
                  <th class="text-center">Sasaran Direktur</th>
              ...
              <tbody>
                <tr class="fs-7" v-for="(title, i) in tableHead" :key="i">
                  ...
                  <td class="text-center">
                    <KTModalComp modal-id="kt_modal_editmapping"> </KTModalComp>
                  </td>
                </tr>
              </tbody>
              <slot></slot>
...
import KTEditMapping from "@/components/epmr/master_ikd/modal_edit/edit_ikd/EditMapping.vue";
import KTModalComp from "@/components/epmr/master_ikd/modal_edit/edit_ikd/modal_comp/ModalCompMapping.vue";

const tableHead = ref([
  {
    kode: "MIKD20230101001",
    tahun: "2023",
    sasaran: "Meningkatnya akses dan mutu pelayanan rumah sakit	",
    indikator:
