              ...
              <tbody>
                <tr class="fs-7" v-for="(title, i) in tableHead" :key="i">
                  ...
                  <td class="text-center">
                    <KTModalComp modal-id="kt_modal_editsasaran"> </KTModalComp>
                  </td>
                </tr>
              </tbody>
              <slot></slot>
...
import KTEditSasaran from "@/components/epmr/master_ikd/modal_edit/edit_ikd/EditSasaran.vue";
import KTModalComp from "@/components/epmr/master_ikd/modal_edit/edit_ikd/modal_comp/ModalCompSasaran.vue";
