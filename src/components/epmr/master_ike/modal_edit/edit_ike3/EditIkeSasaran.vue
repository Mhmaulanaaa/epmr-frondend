<template>
  ...
  <div
    class="modal fade"
    id="kt_modal_editsasaranike"
    ref="newModalEditSasaranIke"
    tabindex="-1"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <!--end::Notice-->
          <el-form
            id="kt_modal_editsasaranike_form"
          ...
          >
            ...
            <div class="float-end">
              <button
                type="reset"
                id="kt_modal_editsasaranike_cancel"
...
export default defineComponent({
  ...
  setup() {
    ...
    const newModalEditSasaranIke = ref<null | HTMLElement>(null);
        ...
        if (valid) {
          ...
          setTimeout(() => {
            ...
            Swal.fire({
              ...
              hideModal(newModalEditSasaranIke.value);
            });
          }, 2000);
        } else {
          Swal.fire({
