<template>
            ...
            >
              <thead>
                ...
                >
                  ...
                  <th class="text-center">Sasaran Eselon 3</th>
                  <th class="text-center">Indikator Kinerja Eselon 3</th>
              ...
              <tbody>
                <tr class="fs-7" v-for="(title, i) in tableHead" :key="i">
                  ...
                  <td class="text-center">
                    <KTModalComp modal-id="kt_modal_editmapindikator">
                    </KTModalComp>
                  </td>
                </tr>
              </tbody>
  ...
  <KTEditMapIndikator></KTEditMapIndikator>
</template>
...
import KTEditMapIndikator from "@/components/epmr/master_ike/modal_edit/edit_ike3/EditIkeMapIndikator.vue";
import KTModalComp from "@/components/epmr/master_ike/modal_edit/edit_ike3/modal_comp/ModalCompMapIndikator.vue";

const tableHead = ref([
  {
    kode: "MIKE320230101001",
    tahun: "2023",
    sasaran:
