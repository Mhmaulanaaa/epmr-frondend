              ...
              <tbody>
                <tr class="fs-7" v-for="(title, i) in tableHead" :key="i">
                  ...
                  <td class="text-center">
                    <KTModalComp modal-id="kt_modal_editmappsasaran">
                    </KTModalComp>
                  </td>
                </tr>
              </tbody>
...
import KTEditMapSar from "@/components/epmr/master_ike/modal_edit/edit_ike3/EditIkeMapSar.vue";
import KTModalComp from "@/components/epmr/master_ike/modal_edit/edit_ike3/modal_comp/ModalCompIkeMapSar.vue";

const tableHead = ref([
  {
    kode: "MSE320230101001	",
    tahun: "2023",
