<template>
              ...
              <tbody>
                <tr class="fs-7" v-for="(title, i) in tableHead" :key="i">
                  ...
                  <td class="text-center">
                    <KTModalComp modal-id="kt_modal_editindikatorike">
                    </KTModalComp>
                  </td>
                </tr>
              </tbody>
  ...
  <KTEditIndikator></KTEditIndikator>
</template>
...
import KTEditIndikator from "@/components/epmr/master_ike/modal_edit/edit_ike3/EditIkeIndikator.vue";
import KTModalComp from "@/components/epmr/master_ike/modal_edit/edit_ike3/modal_comp/ModalCompIkeIndikator.vue";

const tableHead = ref([
  {
    kode: "IKE320230101001",
