              ...
              <tbody>
                <tr class="fs-7" v-for="(title, i) in tableHead" :key="i">
                  ...
                  <td class="text-center">
                    <KTModalComp modal-id="kt_modal_editsasaranike">
                    </KTModalComp>
                  </td>
                </tr>
              </tbody>
...
import KTEditSasaran from "@/components/epmr/master_ike/modal_edit/edit_ike3/EditIkeSasaran.vue";
import KTModalComp from "@/components/epmr/master_ike/modal_edit/edit_ike3/modal_comp/ModalCompIkeSas.vue";
