<template>
  ...
  <div
    class="modal fade"
    id="kt_modal_editrealwadir"
    ref="newModalEditRealWadir"
    tabindex="-1"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h3>Edit Realisasi Indikator Wakil Direktur</h3>
        ...
        <div class="modal-body">
          ...
          <!--end::Notice-->
          <el-form
            id="kt_modal_editrealwadir_form"
          ...
          >
            ...
            <div class="float-end">
              <button
                type="reset"
                id="kt_modal_editrealwadir_cancel"
...
export default defineComponent({
  ...
  setup() {
    ...
    const newModalEditRealWadir = ref<null | HTMLElement>(null);
        ...
        if (valid) {
          ...
          setTimeout(() => {
            ...
            Swal.fire({
              ...
              hideModal(newModalEditRealWadir.value);
            });
          }, 2000);
        } else {
          Swal.fire({
