<template>
  ...
  <div
    class="modal fade"
    id="kt_modal_editrealdirektur"
    ref="newModalEditRealDirektur"
    tabindex="-1"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h3>Edit Realisasi Indikator Direktur</h3>
        ...
        <div class="modal-body">
          ...
          <!--end::Notice-->
          <el-form
            id="kt_modal_editrealdirektur_form"
          ...
          >
            ...
            <div class="float-end">
              <button
                type="reset"
                id="kt_modal_editrealdirektur_cancel"
...
export default defineComponent({
  ...
  setup() {
    ...
    const newModalEditRealDirektur = ref<null | HTMLElement>(null);
        ...
        if (valid) {
          ...
          setTimeout(() => {
            ...
            Swal.fire({
              ...
              hideModal(newModalEditRealDirektur.value);
            });
          }, 2000);
        } else {
          Swal.fire({
