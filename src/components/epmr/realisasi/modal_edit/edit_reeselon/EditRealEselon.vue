<template>
  ...
  <div
    class="modal fade"
    id="kt_modal_editrealeselon"
    ref="newModalEditRealEselon"
    tabindex="-1"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h3>Edit Realisasi Indikator Eselon III</h3>
        ...
        <div class="modal-body">
          ...
          <!--end::Notice-->
          <el-form
            id="kt_modal_editrealeselon_form"
          ...
          >
            ...
            <div class="d-flex flex-column mb-5 fv-row">
              <!--begin::Label-->
              <label class="d-flex align-items-center fs-6 fw-semobold mb-2">
                <span class="required">Realisasi</span>
              </label>
              <!--end::Label-->
            ...
            <div class="col-12">
              ...
              <div class="d-flex flex-column mb-7 fv-row">
                ...
                <textarea
                  v-model="targetData.targetKeterangan"
            ...
            <div class="float-end">
              <button
                type="reset"
                id="kt_modal_editrealeselon_cancel"
...
interface NewAddressData {
  ...
  targetTitle: string;
  targetTarget: string;
  targetRealisasi: string;
  targetCapaian: string;
  targetKeterangan: string;
  assign: string;
  dueDate: string;
...
export default defineComponent({
  ...
  setup() {
    ...
    const newModalEditRealEselon = ref<null | HTMLElement>(null);
        ...
        if (valid) {
          ...
          setTimeout(() => {
            ...
            Swal.fire({
              ...
              hideModal(newModalEditRealEselon.value);
            });
          }, 2000);
        } else {
          Swal.fire({
