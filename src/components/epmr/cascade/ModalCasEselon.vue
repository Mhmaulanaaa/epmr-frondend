<template>
  ...
  <div
    class="modal fade"
    id="kt_modal_caseselon"
    ref="newModalCasEselon"
    tabindex="-1"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h3>Tambah Cascade Eselon III</h3>
...
export default defineComponent({
  ...
  setup() {
    ...
    const newModalCasEselon = ref<null | HTMLElement>(null);
        ...
        if (valid) {
          ...
          setTimeout(() => {
            ...
            Swal.fire({
              ...
              hideModal(newModalCasEselon.value);
            });
          }, 2000);
        } else {
          Swal.fire({
