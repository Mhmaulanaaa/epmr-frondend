<template>
  ...
  <div
    class="modal fade"
    id="kt_modal_casdirektur"
    ref="newModalCasDirektur"
    tabindex="-1"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
        ...
        <div class="modal-body">
          ...
          >
            ...
            <div class="col-12">
              ...
              <div class="d-flex flex-column mb-7 fv-row">
                ...
                <label
                  class="d-flex align-items-center fs-6 fw-semobold form-label mb-2"
                >
                  <span class="">Indikator Kinerja</span>
                </label>
                <!--end::Label-->
            ...
            <div class="float-end">
              <button
                type="reset"
                id="kt_modal_casdirektur_cancel"
...
export default defineComponent({
  ...
  setup() {
    ...
    const newModalCasDirektur = ref<null | HTMLElement>(null);
        ...
        if (valid) {
          ...
          setTimeout(() => {
            ...
            Swal.fire({
              ...
              hideModal(newModalCasDirektur.value);
            });
          }, 2000);
        } else {
          Swal.fire({
