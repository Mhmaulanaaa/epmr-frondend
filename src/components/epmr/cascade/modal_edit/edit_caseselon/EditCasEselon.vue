<template>
  ...
  <div
    class="modal fade"
    id="kt_modal_editcaseselon"
    ref="newModalEditCasEselon"
    tabindex="-1"
    aria-hidden="true"
  >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <!--end::Notice-->
          <el-form
            id="kt_modal_editcaseselon_form"
          ...
          >
            ...
            <div class="float-end">
              <button
                type="reset"
                id="kt_modal_editcaseselon_cancel"
...
export default defineComponent({
  ...
  setup() {
    ...
    const newModalEditCasEselon = ref<null | HTMLElement>(null);
        ...
        if (valid) {
          ...
          setTimeout(() => {
            ...
            Swal.fire({
              ...
              hideModal(newModalEditCasEselon.value);
            });
          }, 2000);
        } else {
          Swal.fire({
    ...
    return {
      ...
      formRef,
      //   rules,
      newModalEditCasEselon,
      getAssetPath,
      pilihjabatan: [
        { select2_pilihjabatan: "Kepala Bagian Perencanaan dan Evaluasi" },
      ],
      pilihsasaran: [
        {
      ...
      pilihindikator: [
        {
          select2_pilihindikator: "Persentase capaian kesesuaian standar GLD",
        },
        {
        ...
        {
          select2_pilihindikator:
            "Persentase rekomendasi Dewas yang ditindaklanjuti",
        },
        {
          select2_pilihindikator:
