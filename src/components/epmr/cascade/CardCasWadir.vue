    ...
    <div class="card-body p-10">
      ...
      <div class="row g-5">
        <div class="col-12">
          ...
          <div class="float-end">
            <KTModalComp button-text="Tambah" modal-id="kt_modal_caswadir">
            </KTModalComp>
          </div>
        </div>
      </div>
  ...
  setup() {
    const tableHead = ref([
      ...
      },
      {
        nomor: "3",
        jabatan: "Wakil Direktur Perencanaan dan Keuangan",
        indikator: "IKM di jajaran Perencanaan dan Keuangan",
        sasaran: "Meningkatnya kemandirian dan akuntabilitas rumah sakit",
        target: "90%",
      },
      {
      ...
      },
      {
        nomor: "7",
        jabatan: "Wakil Direktur Perencanaan dan Keuangan",
        indikator: "Persentase capaian tingkat kemandirian",
        sasaran: "Meningkatnya kemandirian dan akuntabilitas rumah sakit",
        target: "75%",
      },
    ]);
