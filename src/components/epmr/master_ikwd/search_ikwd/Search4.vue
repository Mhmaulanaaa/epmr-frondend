<template>
  <div class="card-body">
    ...
    <div class="row gy-5 g-xl-8">
      <!--begin::Col-->
      <div class="col-6">
        <label class="fs-6 fw-semobold mb-2">Sasaran Wakil Direktur</label>
        <div>
          <v-select
            :options="sasaran"
      ...
      <div class="col-6">
        <label class="fs-6 fw-semobold mb-2"
          >Indikator Kinerja Wakil Direktur</label
        >
        <div>
          <v-select
            :options="indikator"
            label="select2_indikator"
            placeholder="Pilih Indikator Kinerja Wakil Direktur"
          ></v-select>
        </div>
      </div>
      <!--begin::Actions-->
