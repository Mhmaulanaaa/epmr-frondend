<template>
              ...
              <tbody>
                <tr class="fs-7" v-for="(title, i) in tableHead" :key="i">
                  ...
                  <td class="text-center">
                    <KTModalComp modal-id="kt_modal_editsasaranikwd">
                    </KTModalComp>
                  </td>
                </tr>
              </tbody>
  ...
  <KTEditIkwdSasaran></KTEditIkwdSasaran>
</template>
...
import KTEditIkwdSasaran from "@/components/epmr/master_ikwd/modal_edit/edit_ikwd/EditIkwdSasaran.vue";
import KTModalComp from "@/components/epmr/master_ikwd/modal_edit/edit_ikwd/modal_comp/ModalCompIkwdSas.vue";
