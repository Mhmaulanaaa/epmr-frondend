<template>
            ...
            >
              <thead>
                ...
                >
                  ...
                  <th class="text-center">Indikator Kinerja Wakil Direktur</th>
                  <th class="text-center">Sasaran Wakil Direktur</th>
  ...
  <KTEditIkwdMapIndikator></KTEditIkwdMapIndikator>
</template>
...
import KTEditIkwdMapIndikator from "@/components/epmr/master_ikwd/modal_edit/edit_ikwd/EditIkwdMapIndikator.vue";
import KTModalComp from "@/components/epmr/master_ikwd/modal_edit/edit_ikwd/modal_comp/ModalCompIkwdMapIndikator.vue";

const tableHead = ref([
  {
    kode: "MIKWD20230101001	",
    tahun: "2023",
    sasaran:
      "Meningkatnya kemandirian dan akuntabilitas rumah sakitMeningkatnya kemandirian dan akuntabilitas rumah sakit",
    indikator:
...
export default {
  methods: {
    KTEditIkwdMapIndikator,
    KTModalComp,
    hapusinfoikwdmappingkinerja() {
      Swal.fire({
