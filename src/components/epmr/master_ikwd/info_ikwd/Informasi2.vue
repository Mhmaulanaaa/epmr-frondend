<template>
              ...
              <tbody>
                <tr class="fs-7" v-for="(title, i) in tableHead" :key="i">
                  ...
                  <td class="text-center">
                    <KTModalComp modal-id="kt_modal_editindikatorikwd">
                    </KTModalComp>
                  </td>
                </tr>
              </tbody>
  ...
  <KTEditIkwdIndikator></KTEditIkwdIndikator>
</template>
...
import KTEditIkwdIndikator from "@/components/epmr/master_ikwd/modal_edit/edit_ikwd/EditIkwdIndikator.vue";
import KTModalComp from "@/components/epmr/master_ikwd/modal_edit/edit_ikwd/modal_comp/ModalCompIkwdIndikator.vue";

const tableHead = ref([
  {
    kode: "IKWD20230101001",
    indikator:
