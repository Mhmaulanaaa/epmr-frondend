<template>
              ...
              <tbody>
                <tr class="fs-7" v-for="(title, i) in tableHead" :key="i">
                  ...
                  <td class="text-center">
                    <KTModalComp modal-id="kt_modal_editmapingsasaran">
                    </KTModalComp>
                  </td>
                </tr>
              </tbody>
  ...
  <KTEditIkwdMapSar></KTEditIkwdMapSar>
</template>
...
import KTEditIkwdMapSar from "@/components/epmr/master_ikwd/modal_edit/edit_ikwd/EditIkwdMapSar.vue";
import KTModalComp from "@/components/epmr/master_ikwd/modal_edit/edit_ikwd/modal_comp/ModalCompIkwdMapSar.vue";

const tableHead = ref([
  {
    kode: "MSWD20230101001",
    tahun: "2023",
    sasaran: "Meningkatnya kemandirian dan akuntabilitas rumah sakit",
    indikator:
