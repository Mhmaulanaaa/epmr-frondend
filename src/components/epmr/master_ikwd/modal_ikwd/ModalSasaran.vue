...
export default defineComponent({
  ...
  setup() {
    ...
    const newModalSasaran = ref<null | HTMLElement>(null);
        ...
        if (valid) {
          ...
          setTimeout(() => {
            ...
            Swal.fire({
              ...
              hideModal(newModalSasaran.value);
            });
          }, 2000);
        } else {
          Swal.fire({
