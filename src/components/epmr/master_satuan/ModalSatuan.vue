        ...
        <div class="modal-body">
          ...
          >
            ...
            <div class="d-flex flex-column mb-5 fv-row">
              ...
              <el-form-item prop="targetTitle1">
                <el-input
                  v-model="targetData.targetTitle1"
            ...
            <div class="d-flex flex-column mb-5 fv-row">
              ...
              <el-form-item prop="targetTitle2">
                <el-input
                  v-model="targetData.targetTitle2"
...
export default defineComponent({
  ...
  setup() {
    ...
    const newModalSatuan = ref<null | HTMLElement>(null);
        ...
        if (valid) {
          ...
          setTimeout(() => {
            ...
            Swal.fire({
              ...
              hideModal(newModalSatuan.value);
            });
          }, 2000);
        } else {
          Swal.fire({
